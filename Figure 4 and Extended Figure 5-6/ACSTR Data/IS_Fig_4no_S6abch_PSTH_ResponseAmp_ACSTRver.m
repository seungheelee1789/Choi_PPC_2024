...
StimName{1,1} = 'Fig S6b, Vgo'; StimName{1,3} = 'Fig S6b, Vnogo'; StimName{2,1} = 'Fig S6a, Ago'; StimName{2,3} = 'Fig S6a, Anogo';
...
%ylim([]);
mkdir('Figure'); cd('Figure');
saveas(fig,['Fig S6c, Unisensory response amplitude.svg']);
cd ../
...
StateName{1} = 'Fig 4n, Stationary'; StateName{2} = 'Fig 4o, Moving';
...
mkdir('Figure'); cd('Figure');
saveas(fig,'Fig S6h, Incon response amplitude.svg');
cd ../
%%
% clearvars StimType LocoType Data Type1 Type2 Type3 Type4 N
% 
