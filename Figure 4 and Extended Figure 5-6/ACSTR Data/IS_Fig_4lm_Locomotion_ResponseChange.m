...
saveas(fig,['Fig 4l, Locomotion Onset PSTH.svg']);
cd ../
...
mkdir('Figure'); cd('Figure');
saveas(fig,['Fig 4m, Locomotion Offset PSTH.svg']);
cd ../
...
mkdir('Figure'); cd('Figure');
saveas(fig,'Fig 4l, Locomotion Onset Correlation Histogram.svg');
cd ../
...
mkdir('Figure'); cd('Figure');
saveas(fig,'Fig 4m, Locomotion Offset Correlation Histogram.svg');
cd ../
