...
% according to locomotion state (Figure 4p)
...
saveas(fig,'Fig 4p, VgoAnogo MvmtSorted ResponseAmplitude.svg');
cd ../
...
mkdir('Figure'); cd('Figure');
saveas(fig,'Fig 4p, AgoVnogo MvmtSorted ResponseAmplitude.svg');
cd ../